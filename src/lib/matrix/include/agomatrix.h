...
#define QUANT_BLOCKS (MAX_MATRIX_SIZE / CHUNKSIZE)
#define NUM_BLOCKS ((QUANT_BLOCKS * QUANT_BLOCKS) + 1)

#define FILE_NAME_MATRIX_A "matrixA.dat"
#define FILE_NAME_MATRIX_B "matrixB.dat"

typedef double Matrix[MAX_MATRIX_SIZE];

// Funcoes de Manipulacao de Matrizes
